...
class StatesQuizFragment : Fragment(){
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        Log.d(TAG, "StatesQuizFragment onCreateView")
        return inflater.inflate(R.layout.quiz_state, container, false)
    }
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        super.onViewCreated(view, savedInstanceState)
        Log.d(TAG, "StatesQuizFragment onViewCreated")
        ...
        statesViewModel.getCurrentState()
                .observe(viewLifecycleOwner, Observer { newQuizState ->
                    ...
                    Log.d(TAG, "StatesQuizFragment onViewCreated: newQuizState = $newQuizState")
                })
    }
    ...
    private fun showNotWellState(data: DataFlags) {
        getNumberOnChipName(data)//показываем количество стран в регионе
        statesViewModel.writeMistakeInDatabaseCoroutine() //делаем отметку об ошибке в базе данных
