...
import com.bartex.statesmvvm.view.fragments.states.scheduler.ScheduleProviderStub
...
class StatesViewModelTest {
    ...
    fun setUp() {
        ...
        statesViewModel = StatesViewModel(helper, ScheduleProviderStub(), statesRepo)
    }
